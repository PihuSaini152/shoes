...
const shoes = [
  ...
  { id: 2, image: "/Women-Shoes/womenshoes2.avif", price: 88.23, name: "Women's Trail Blazer", selling: "NEW" },
  { id: 3, image: "/Women-Shoes/womenshoes3.avif", price: 54.78, name: "Women's Forest Trekker", selling: "BESTSELLER" },
  { id: 4, image: "/Women-Shoes/womenshoes4.avif", price: 97.12, name: "Women's Mountain Runner", selling: "BESTSELLER" },
  { id: 5, image: "/Women-Shoes/womenshoes5.avif", price: 66.34, name: "Women's Canyon Stride", selling: "BESTSELLER" },
  ...
  { id: 15, image: "/Women-Shoes/womenshoes15.avif", price: 69.00, name: "Women's Comfort Hiker", selling: "NEW" },
  { id: 16, image: "/Women-Shoes/womenshoes16.avif", price: 71.30, name: "Women's Airstep", selling: "" },
  { id: 17, image: "/Women-Shoes/womenshoes17.avif", price: 87.25, name: "Women's Flex Trek", selling: "BESTSELLER" },
  ...
  { id: 20, image: "/Women-Shoes/womenshoes20.avif", price: 68.75, name: "Women's Earthbound", selling: "BESTSELLER" },
  { id: 21, image: "/Women-Shoes/womenshoes21.avif", price: 84.90, name: "Women's Zenith Dash", selling: "30% OFF" },
  { id: 22, image: "/Women-Shoes/womenshoes22.avif", price: 62.35, name: "Women's Natural Step", selling: "BESTSELLER" },
  ...
  { id: 27, image: "/Women-Shoes/womenshoes27.avif", price: 91.30, name: "Women's Velocity Trail", selling: "NEW" },
  ...
  return (
   <>
<div className="women-seller-bg">
    <h2>Bestsellers For A Reason</h2>
    <h4>Everyone loves these super versatile styles—and so will you.</h4>
</div>

    <div className='women-shoes-main'>
      <div className="women-shoes-card">
        {
            shoes.slice(2,4).map((shu)=>(
         ...
         <div className="women-sellcard">
  
</div>
 {
            shoes.slice(4,9).map((shu)=>(
                <div key={shu.id} className="women-shoe-deta">
                    <div className="women-shoes-image">
                        <img src={shu.image} alt="" />
                        <h3>{shu.selling}</h3>
         ...
         <div className="women-sellcard1">
  
</div>

 {
            shoes.slice(11,15).map((shu)=>(
                <div key={shu.id} className="women-shoe-deta">
                    <div className="women-shoes-image">
                        <img src={shu.image} alt="" />
                        <h3>{shu.selling}</h3>
