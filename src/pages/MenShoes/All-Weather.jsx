...
function Weather() {
   const labels = ["WATER-REPLESMENT", "WATER-REPLESMENT", "WATER-REPLESMENT ON/OFF", "WATER-REPLESMENT"];
...
const shoes = [
  ...
  { id: 5, image: "/Men-Shoes/Sneakers/menshoes34.avif", price: 89.77, name: "Men's Ridge Runner", selling: "EASY ON/OFF" },
  { id: 6, image: "/Men-Shoes/Sneakers/menshoes35.avif", price: 69.31, name: "Men's Peak Stride", selling: "BESTSELLER" },
  ];
